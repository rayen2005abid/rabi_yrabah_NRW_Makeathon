...
echo ============================================================
echo SOPALTEC phone camera scanner
echo ============================================================
...
if exist ".venv\Scripts\python.exe" (
  ...
  python -m src.simple_camera --artifact artifacts/core_classifier_simple_v4 --config configs/default.yaml --source "%PHONE_CAMERA_URL%" --no-mirror
)
